...
public class ElementUtil {
	...
	@Step("doGetElementText-{locator}")
	public String doGetElementText(By locator) {
		return getElement(locator).getText();
	}
	@Step("doElementGetAttribute-{locator}")
	public String doElementGetAttribute(By locator, String attrName) {
		return getElement(locator).getAttribute(attrName);
	}
	@Step("isElementDisplayed-{locator}")
	public boolean isElementDisplayed(By locator) {
		return getElement(locator).isDisplayed();
	}
	@Step("isElementExist-{locator}")
	...
	@Step("checking and waiting waitForElementVisible{locator}")
	...
	public void alertSendKeys(int timeOut, String value) {
	  ...
	  WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
	  return
	  wait.until(ExpectedConditions.numberOfWindowsToBe(totalNumberOfWindowsToBe));
	  }
